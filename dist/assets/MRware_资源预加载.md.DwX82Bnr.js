import{_ as e,C as p,c as l,o as i,j as n,G as r,aj as t,a as c}from"./chunks/framework.CsqNip8P.js";const y=JSON.parse('{"title":"资源预加载，提升用户体验","description":"","frontmatter":{},"headers":[],"relativePath":"MRware/资源预加载.md","filePath":"MRware/资源预加载.md","lastUpdated":1754587253000}'),o={name:"MRware/资源预加载.md"};function u(b,s,d,m,_,h){const a=p("ArticleMetadata");return i(),l("div",null,[s[0]||(s[0]=n("h1",{id:"资源预加载-提升用户体验",tabindex:"-1"},[c("资源预加载，提升用户体验 "),n("a",{class:"header-anchor",href:"#资源预加载-提升用户体验","aria-label":'Permalink to "资源预加载，提升用户体验"'},"​")],-1)),r(a),s[1]||(s[1]=t(`<p>三个思路 第一个思路通过鼠标悬浮，事件监听移动到的字段列，实现预加载</p><div class="language- vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>import { useQueryClient } from &quot;@tanstack/react-query&quot;;</span></span>
